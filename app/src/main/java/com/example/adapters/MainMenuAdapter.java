...
public class MainMenuAdapter extends ArrayAdapter<MainMenu> {
    ...
    private int layout;
    private List<com.example.objects.MainMenu> states;

    public MainMenuAdapter(Context context, int resource, List<com.example.objects.MainMenu> states) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.objects.MainMenu menu = states.get(position);
